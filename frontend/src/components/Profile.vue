					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div v-if="currentUser_type=='employee'" class="mt-3">
									<h4>{{currentEmployee.first_name}} {{currentEmployee.last_name}}</h4>
									<p class="text-secondary mb-1">{{currentEmployee.position}}</p>
									<p class="text-muted font-size-sm">{{currentEmployee.citizenship}}</p>
									<button class="btn btn-primary">Follow</button>
									<button class="btn btn-outline-primary">Message</button>
								</div>
								<div v-if="currentUser_type=='company'" class="mt-3">
									<h4>{{currentCompany.name}}</h4>
									<p class="text-secondary mb-1">{{currentCompany.location}}</p>
									<p class="text-muted font-size-sm">{{currentCompany.number_of_employees}}</p>
									<button class="btn btn-primary">Follow</button>
									<button class="btn btn-outline-primary">Message</button>
								</div>
							</div>
