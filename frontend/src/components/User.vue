                                ...
                                <div>
                                    <b-modal id="modal-1" title="Добавить новый навык" hide-footer>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="eg: 33" v-model="skill_progress">
                                            </div>
    ...
    methods: {
        ...
        registerSkill() {
            const skill = {
                ...
                employee_id: this.$store.getters.currentEmployee.id
            }
            console.log('FORM SKILL', skill);
            this.$store.dispatch('createSkill', skill).then(()=> {
                //this.$router.push('/users/'+this.currentEmployee.id)
            })
        },
        deleteSkill(id) {
            console.log(id);
            this.$store.dispatch('deleteSkill', id).then(()=> {
                //this.$router.push('/users/'+this.currentEmployee.id)
            })
        }
    },
